/* ─── What Is Meticulosity.io Page Content ─── */

/* ─── Hero ─── */
export const wioHero = {
...
export const threeThings = {
  intro:
    "There are three things that make Meticulosity.io different from every other automation tool, consultant, or platform you've looked at. Get these three things and you'll understand why agencies that try it don't go back.",
  cards: [
    {
      number: "01",
    ...
    },
    {
      ...
      subtitle: "We don't hand you a playbook and wish you luck.",
      body: "We don't teach you how to fish. We do the fishing for you, then serve it tableside. There's no training phase where your team tries to learn a new system. No \"here's a recommended workflow\" document that collects dust. We deploy working automations and operate them. Permanently.",
    },
    {
      number: "03",
  ...
  steps: [
    {
      ...
      callout:
        "Without a data layer, each automation would need its own fragile way of looking things up. With it, every automation draws from the same single source of truth.",
    },
    {
      number: "02",
    ...
    },
    {
      ...
      body: "This is where managed service means something. We monitor, maintain, and optimize every automation on an ongoing basis. When something breaks, we fix it. When your operations change, we adapt. When a better approach exists, we upgrade.",
      details:
        "Your team never touches a workflow. Nobody on your staff needs to understand how the automations work, troubleshoot errors, or remember to check that things are running. That's entirely on us.",
    },
  ],
  bottomCallout:
...
export const dataLayerDeep = {
  ...
  problemIntro:
    "Right now, your agency's data lives in 8 to 12 different tools. Your PM tool knows who's working on what. Your accounting system knows who paid. Your CRM knows deal stages. But no single system can answer the question that actually matters:",
  pullQuote:
  ...
  features: [
    {
      ...
      description:
        "Which clients are active, what they purchased, what's been invoiced, and what hasn't. Your accounting system and CRM feed into a single view that always reflects reality.",
    },
    {
      title: "Task and Project Data",
      description:
        "Every task in your PM tool syncs to the data layer with its client, assignee, status, priority, and timestamps. This is how the system knows what work is happening and who it belongs to.",
    },
    {
      title: "Time Entry Data",
      description:
        "The heartbeat of the entire system. Every time entry records who logged it, which task it belongs to, and how long it took. This is the raw material that powers burn reports, utilization tracking, and capacity planning.",
    },
    {
  ...
  howItConnects:
    "A time entry is logged in your PM tool. It syncs to the data layer. It's linked to a task, which traces back to a client, who has a defined number of purchased hours. The system can now calculate utilization in real time: \"Client X has used 47.3 hours out of their 60-hour block this month.\" No exports. No spreadsheets. No reconciliation.",
  howItConnectsIntro:
    "The power isn't in any single piece. It's in how they relate to each other.",
  builtForAi:
...
export const featuredAutomations = {
  ...
  automations: [
    ...
    },
    {
      ...
      tags: ["AI-Powered Intelligence"],
      stat: "15 to 20 hours saved per month",
      body: "When a client submits a work request, AI analyzes the submission, categorizes it by skill tier and complexity, identifies missing information, and suggests clarifying questions before work begins. The right team gets notified with context already attached.",
      pain: "Without triage, every incoming request lands on one person's plate. They read it, try to understand it, ask questions, wait for answers, then route it. Multiply that by 20 to 30 requests per week across 15+ clients and you've found your bottleneck.",
    },
  ],
  catalogCta: {
...
export const aiSection = {
  headline: "AI Embedded in Workflows, Not Pasted from ChatGPT",
  intro:
    "Most agencies are already using AI. Someone opens ChatGPT, writes a prompt, reviews the output, copies it somewhere. The result: inconsistent quality, variance between team members, and adoption that depends entirely on who remembers to do it.",
  introFollowup: "Meticulosity.io takes a different approach.",
  howDifferent:
    "Our AI runs inside operational workflows, not alongside them. Every AI-powered automation uses standardized prompts that produce consistent outcomes. No manual prompting. No copy-paste. No variance between team members. No dependence on one person remembering to use it.",
  howDifferentFollowup:
    "The value of AI in a service business isn't the AI itself. It's the automation layer that ensures AI is applied consistently, every time, without anyone having to remember.",
  examples: [
    {
      title: "Task Triage",
      description:
        "AI reads incoming client requests and categorizes them by type, complexity, and skill tier. It identifies missing information and drafts clarifying questions before work begins.",
    },
    {
      title: "Call Transcript Processing",
      description:
        "AI matches transcripts to client task lists, identifies which tasks were discussed, extracts action items, and writes summaries that get posted directly to your PM tool.",
    },
    {
      title: "Work Summary Generation",
      description:
    ...
    rows: [
      {
        ...
        hours: "112",
        drivers: "60+ burn reports, time sync, budget enforcement",
      },
      {
        category: "AI-Powered Intelligence",
        hours: "60",
        drivers: "Task enrichment, triage, transcript processing",
      },
      {
        category: "Client Lifecycle",
        hours: "31",
        drivers: "New client onboarding, post-sales follow-ups",
      },
      {
        category: "Data Synchronization",
        hours: "30",
        drivers: "Task and time entry sync across systems",
      },
      {
    ...
    rows: [
      {
        ...
        values: ["$1,000,000", "$3,000,000", "$5,000,000"],
      },
      {
      ...
      {
        label: "Margin Impact",
        values: ["+15pp", "+13pp", "+12pp"],
      },
      {
        label: ".io Annual Investment",
        values: ["~$18,300", "~$46,800", "~$74,500"],
      },
      {
        label: "Cost if Done by Staff",
        values: ["~$153,000/yr", "~$390,000/yr", "~$621,000/yr"],
      },
      {
        label: "Net Annual Savings",
        values: ["~$135,000", "~$344,000", "~$548,000"],
      },
      {
        label: "ROI Multiple",
        values: ["8x", "8x", "8x"],
...
export const toolsGrid = {
  ...
  intro:
    "Meticulosity.io is platform and tool agnostic. It doesn't matter if you run ClickUp or Monday.com, or whether you use Xero instead of QuickBooks Online. You don't rip down and rebuild. You use your tools.",
  categories: [
    {
      name: "Project Management",
      tools: ["ClickUp", "Monday.com", "Asana", "Teamwork", "Wrike", "Basecamp"],
    },
    {
      name: "CRM",
    ...
    },
    {
      ...
      tools: ["QuickBooks", "Xero", "FreshBooks", "Harvest", "Wave"],
    },
    {
      name: "E-Signature & Proposals",
      tools: ["PandaDoc", "DocuSign", "Proposify", "HubSpot Quotes", "Qwilr"],
    },
    {
      name: "Team Communication",
      tools: ["Slack", "Microsoft Teams", "Google Chat", "Discord"],
    },
    {
      name: "Cloud Productivity",
      tools: ["Google Workspace", "Microsoft 365", "Notion", "Dropbox"],
    },
    {
      name: "Call Transcription & Meeting Intelligence",
      tools: ["Fireflies", "Gong", "Otter.ai", "Fathom", "Chorus"],
    },
    {
      name: "Telephony & VoIP",
      tools: ["JustCall", "RingCentral", "Aircall", "Dialpad", "OpenPhone"],
    },
    {
      name: "AI Engines",
      tools: ["Claude", "GPT", "Perplexity", "Gemini", "Mistral"],
    },
    {
      name: "Data Layer & Reporting",
      tools: ["Airtable", "Smartsheet", "Google Sheets", "Excel", "Coda"],
    },
    {
      name: "CMS & Blogging",
      tools: ["HubSpot CMS", "WordPress", "Webflow", "Ghost", "Contentful"],
    },
    {
      name: "Visitor Identification & Intent",
      tools: ["RB2B", "Clearbit Reveal", "6sense", "Leadfeeder", "ZoomInfo"],
    },
    {
...
export const whatItsNot = {
  headline: "Let's Be Clear About What This Isn't",
  intro:
    "We get these questions in almost every discovery call. Better to address them head-on.",
  cards: [
    {
      title: "It's not a replacement for your PM tool.",
      body: "We sit on top of your existing tools. You keep ClickUp, Monday, Asana, or whatever you use. We don't ask you to migrate anything. Your team keeps working exactly where they work now.",
    },
    {
      title: "It's not a one-time implementation.",
      body: "We don't set things up and walk away. This is a managed service with ongoing monitoring, maintenance, and optimization. When things change, we adapt. When new automations make sense, we deploy them.",
    },
    {
      title: "It's not a DIY automation platform.",
      body: "Your team never has to build, configure, or maintain workflows. You don't need an \"automation person\" on staff. You don't need to learn a platform. We handle the entire technology layer.",
    },
  ],
};

/* ─── Origin Story ─── */
export const wioOriginStory = {
  ...
  badges: [
    ...
    "11+ Years HubSpot Partner",
    "5,800+ Projects Completed",
    "Netty Award: Best Small Agency 2025",
    "Boutique Agency of the Year 2023",
  ],
};
  ...
  items: [
    {
      ...
      answer:
        "Most agencies are live with their first automations within 2 to 4 weeks. We start with discovery (mapping your tools, identifying the highest-impact workflows), then build your data layer and deploy automations in phases. You don't wait months to see results.",
    },
    {
      id: "team-change",
    ...
    {
      id: "tools",
      question: "What if our tools aren't on your supported list?",
      answer:
        "Our supported list covers the vast majority of agency tech stacks. If you use something unusual, we'll evaluate it during discovery. In most cases, if the tool has a modern integration layer, we can work with it.",
    },
    {
      id: "measurement",
      question: "How do we know it's actually saving time?",
      answer:
        "Every automation has a pre-measured \"hours saved\" value based on actual manual timing. We report weekly and monthly on exactly which automations ran, how many times, and how many hours they saved. Complete transparency.",
    },
    {
      id: "reliability",
      question: "What happens if something breaks?",
      answer:
        "We monitor everything. If an automation fails or behaves unexpectedly, our team is notified and handles the fix. You don't troubleshoot. You don't file a ticket. We own reliability.",
    },
    {
      id: "contract",
      question: "Is there a long-term contract?",
      answer:
        "We require a 4-month minimum commitment with no setup fees. After that, the service continues month-to-month. We earn your business through measurable results, not contractual lock-in.",
    },
    {
      id: "vs-hire",
      question: "How is this different from hiring an ops person?",
      answer:
        "An ops hire in North America costs $80,000 to $120,000 per year. They get sick, take vacations, forget things, and can only work on one task at a time. Our automations run 24/7 with perfect consistency, starting at $500 per month. Most agencies see 6 to 10x ROI compared to the cost of equivalent headcount.",
    },
    {
      id: "start-small",
...
export const wioNav = {
  links: [
    ...
    { label: "Automations", href: "#featured-automations" },
