...
export const hero = {
  ...
  subheadline:
    "Your tools. Our automations. Zero workflows to build or maintain. 50+ automations running across your existing stack, saving 230+ hours every month.",
  primaryCta: "Book a Free Assessment",
  secondaryCta: "See How It Works",
  proofLine: "Currently saving 230+ hours/month across 60+ clients",
  layers: {
    bottom: {
      label: "Your Existing Tools",
      tools: ["ClickUp", "HubSpot", "QuickBooks", "Slack", "Gmail"],
    },
    middle: { label: "Connected Data Layer" },
    top: {
  ...
  steps: [
    {
      ...
      description:
        "We connect your PM tool, accounting system, CRM, and comms into one shared data layer. Think of it as a master roster that always knows which clients are active, who's working on what, and how many hours have been used. This is the foundation that makes every automation reliable.",
    },
    {
      number: "02",
      title: "We Deploy Automations",
      description:
        "From our library of 50+ automations running live across multiple agencies, we activate the ones that match your operations: burn reports, onboarding, time sync, budget alerts, and more. No building. No configuration. No maintenance.",
    },
    {
      number: "03",
      title: "We Run Everything",
      description:
        "We monitor, maintain, and optimize every automation on an ongoing basis. When something changes (a new client, updated process, or tool upgrade) we handle it. Your team never touches a workflow.",
    },
  ],
};
...
export const originStory = {
  ...
  paragraphs: [
    ...
    "Running 60+ agency clients forced a choice: automate or break. We chose to automate. Over two years, we built a library of 50+ automations that now save 230+ hours per month of manual work.",
    "That's the equivalent of 1.5 full-time hires, running around the clock at a fraction of the cost. And here's the key: we're a boutique firm. If these results are possible at our scale, the impact for a 30-, 50-, or 100-person agency would be significantly higher.",
  ],
  timeline: [
    { year: "2008", event: "Meticulosity founded" },
    { year: "2014", event: "HubSpot Partner since day one of the partner program" },
    { year: "2024", event: "$20,000 billing crisis; first automation deployed" },
    { year: "2025", event: "30+ automations live; Meticulosity Global formed" },
...
export const automationShowcase = {
  ...
  cards: [
    ...
    },
    {
      ...
      hoursSaved: "Enables all reporting",
      tags: [],
    },
    {
    ...
    },
    {
      ...
      category: "Data Synchronization",
      description:
        "Syncs all tasks and time entries from your PM tool every night, keeping reporting and automations accurate.",
      hoursSaved: "Enables all reporting",
      tags: [],
    },
  ] as AutomationCard[],
...
export const dataLayer = {
  ...
  paragraphs: [
    "Your agency's data lives in 8-12 different tools. Your PM tool knows who's working on what. Your accounting system knows who paid. Your CRM knows deal stages. But no single system can answer the question that actually matters:",
    "Before a single automation runs, we connect your tools into one shared view. Every time entry traces back to a task, which traces to a client, which traces to purchased hours. That chain is what makes burn reports, budget alerts, and every other automation possible.",
    "You never see or interact with it directly. It runs in the background, stays in sync, and gives every automation a reliable foundation.",
  ],
  pullQuote:
    "How many hours has this client used out of the hours they purchased?",
  stats: [
    { value: "60+", label: "clients connected" },
    { value: "8+", label: "tool integrations supported" },
    { value: "24/7", label: "sync running continuously" },
  ],
...
export const stats = {
  ...
  items: [
    ...
    { value: 60, suffix: "+", label: "Clients served", color: "purple" },
    { value: 50, suffix: "+", label: "Live automations", color: "purple" },
    { value: 17, suffix: "+", label: "Years of agency operations", color: "blue-gray" },
    { value: 1.5, suffix: "", prefix: "~", label: "Full-time hires replaced", color: "green" },
  ],
};
...
export const pricing = {
  ...
  subheadline: "Priced like a VA who never sleeps and never misses a step.",
  tiers: [
    {
  ...
  explanation:
    "Every automation has a pre-measured \"hours saved\" value based on how long that work takes a person to do manually. Your monthly investment equals the total hours saved across all your active automations, multiplied by your per-hour rate.",
  roi: {
...
export const about = {
  ...
  paragraphs: [
    'Meticulosity.io is a product of Meticulosity, a white-label HubSpot agency founded in 2008. For 17+ years, we\'ve served as "The HubSpot Agency for Agencies," delivering HubSpot services under partner agency brands. In 2025, we expanded globally with teams across North America, UAE, Saudi Arabia, and Egypt.',
    "Every automation in our library was built because we hit the problem ourselves first. This isn't a product designed by people who think they know what agencies need. It's built by people who've run an agency for nearly two decades.",
  ],
  credentials: [
